...
urlpatterns = [
    ...
    path(
        "<int:pk>/siap-diambil/",
        views.transaksi_siap_diambil,
        name="transaksi_siap_diambil",
    ),
    ...
    path(
        "<int:pk>/print-persiapan/",
        views.transaksi_print_persiapan,
        name="transaksi_print_persiapan",
    ),
    path("<int:pk>/invoice/", views.transaksi_invoice, name="transaksi_invoice"),
    path(
        "<int:pk>/pembayaran/tambah/", views.tambah_pembayaran, name="tambah_pembayaran"
    ),
    path(
        "<int:pk>/pembayaran/<int:pembayaran_pk>/hapus/",
        views.hapus_pembayaran,
        name="hapus_pembayaran",
    ),
]
