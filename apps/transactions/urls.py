...
urlpatterns = [
    ...
    path('<int:pk>/pembayaran/tambah/', views.tambah_pembayaran, name='tambah_pembayaran'),
    path('<int:pk>/pembayaran/<int:pembayaran_pk>/hapus/', views.hapus_pembayaran, name='hapus_pembayaran'),
]