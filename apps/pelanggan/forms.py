...
class PelangganForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'hp': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '08xx-xxxx-xxxx'}),
            ...
            'catatan': forms.Textarea(attrs={'class': 'form-control', 'rows': 2, 'placeholder': 'Catatan khusus pelanggan'}),
        }
